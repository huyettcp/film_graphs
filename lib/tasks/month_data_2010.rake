namespace :month_data_2010 do
  desc "Generates month data for 2010"
  ...
  n = Nokogiri::HTML(open("http://www.boxofficemojo.com/monthly/?view=releasedate&chart=byyear&yr=2010&view=releasedate"))
  noko = 2
