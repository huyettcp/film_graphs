namespace :month_data_2013 do
    desc "Generates month data for 2013"
  ...
  n = Nokogiri::HTML(open("http://www.boxofficemojo.com/monthly/?view=releasedate&chart=byyear&yr=2013&view=releasedate"))
  noko = 2
